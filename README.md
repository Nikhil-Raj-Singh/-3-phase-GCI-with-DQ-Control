# -3-phase-GCI-with-DQ-Control
Mathematical Modeling of 3-phase GCI with DQ control
Project Overview


This project involves the development of a mathematical model for a 3-phase grid-connected inverter (GCI) using DQ control theory.
The model aims to simulate and analyze the performance of the inverter in various operating conditions.
